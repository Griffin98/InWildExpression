...
from criteria.deca.models.decoders import Generator
from criteria.deca.utils import util
from criteria.deca.utils.rotation_converter import batch_euler2axis
from criteria.deca.utils.tensor_cropper import transform_points
from criteria.deca.utils.config import cfg
...
class DECAModel(nn.Module):
    ...
    def decode(self, codedict, rendering=True, iddict=None, vis_lmk=True, return_vis=True, use_detail=True,
        ...
        mask_face_eye = F.grid_sample(self.uv_face_eye_mask.expand(batch_size, -1, -1, -1),
