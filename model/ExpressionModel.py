...
from networks.encoder_adain import StylizedExpressionEncoder
from networks.stylegan2_concat import Generator, Discriminator


from utils.load_stylegan_weights import load_stylegan_dict
...
class ExpressionModel(nn.Module):
    def __init__(self, opts):
        ...
        if opts.load_stylegan_weights and opts.training_stage == "imitate":
            ...
            modified_dict = load_stylegan_dict(self.decoder, pretrained_dict, log_size - 1)
